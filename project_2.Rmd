...
(Some of these don't make intuitive sense...could be result of multicollinearity in models)

## Linear Regression risk factors
...
## Logistic Model default factors
...
The market does not consider a risk factor but it actually is:
...
The market considers a risk factor but it actually isn't:
