...
listings_glm <- subset(listings_glm, loan_status_description != "CHARGEBACK") #Removes charge back (will change to DEFAULT after asking professor)

listings_glm$loan_status_description <- ifelse(listings_glm$loan_status_description == "DEFAULTED", 1, 0) #assigned 1 if loan defaulted, 0 if completed
```
