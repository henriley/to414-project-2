...
# For NA values that appeared in our model, if two variables are too highly correlated, it is possible to appear as NA values. Another predictor variables may capture the variables, so we decided to remove those.
